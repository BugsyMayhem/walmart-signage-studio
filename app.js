...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${w} ${h}" width="100%" height="100%" class="signage-svg-element">
    ...
    ${barcodeSVG}
        ...
        const hasCategoryText = categoryVal.trim().length > 0;

        if (state.toggleCategory && hasCategoryText) {
            ...
            // Center the badge between the top boundary (spark bottom or top accent bar) and first divider
